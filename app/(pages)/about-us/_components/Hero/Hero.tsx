export default function Hero() {
  return (
    <div className="relative isolate w-full h-[225vh] bg-white">
        ...
        <div>
          <img src="/Images/cloud_and_book.svg" alt="Cloud and Book" className="w-full relative z-30" />
        <img src="/Images/Cow.svg" alt="HD Cow" className="absolute top-[14vw] left-[8%] z-10 w-[40vw] h-auto bob-slow z-30" />
        </div>
        ...
        <div className="absolute z-0 top-[140vh] left-[12%] text-white">
          <div className="relative border border-white py-[2vw] px-[1vw] pr-[2vw]">
            ...
            <h1 className="font-[var(--font-metropolis)] font-black mx-[2vw] mb-[1vw] tracking-[0.02em]">About Us</h1>
            <p className="font-[var(--font-metropolis)] my-[2vw] mx-[2vw] max-w-[25vw]">HackDavis is one of the largest collegiate hackathons in California where over 950 students, creators, and leaders come together to create for social good. </p>
          </div>
        </div>
        <div>
          <div className="bob-slow glass-bubble absolute z-30 top-[115vh] left-[70vw] text-white !w-[8vw] !h-[8vw] !p-0 !gap-0 rounded-full flex items-center justify-center text-[clamp(0.8rem,2vw,1.6rem)] leading-[1.02] text-center font-semibold"
          style={{
            ...
            <span className="block max-w-[80%]">24<br />Hours</span>
          </div>
          <div className="bob-slow glass-bubble absolute z-10 top-[140vh] left-[55vw] text-white !w-[15vw] !h-[15vw] !p-0 !gap-0 rounded-full flex items-center justify-center text-[clamp(1rem,2.5vw,2rem)] leading-[1.02] text-center font-semibold"
          style={{
          ...
          <div className="bob-slow glass-bubble absolute z-30 top-[135vh] left-[78vw] text-white !w-[11vw] !h-[11vw] !p-0 !gap-0 rounded-full flex items-center justify-center text-[clamp(0.9rem,2.2vw,1.8rem)] leading-[1.02] text-center font-semibold"
          style={{
          ...
          >
            <span className="block max-w-[80%]">150+ <br /> Projects</span>
          </div>
          <div
          ...
          >
            <span className="block max-w-[80%]">900+<br /> Hackers</span>
          </div>
        </div>
