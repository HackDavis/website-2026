...
export default function Hero() {
  return (
    <div className="font-[var(--font-metropolis)] relative isolate w-full pb-20 md:pb-5 bg-white">
      ...
      <div
        className="absolute z-10 top-[125vw] left-[6%] w-[50vw] h-[200vw] text-white sm:w-[42vw] sm:min-h-[120vw] sm:top-[60%] md:top-[70vw] md:left-[10%] md:w-[40vw] lg:top-[75vw] lg:left-[12%] lg:w-auto"
      >
