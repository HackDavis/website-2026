      ...
      <div className="flex flex-row items-stretch gap-6">
        ...
        <div>
          <Image
            ...
            width={100}
            height={100}
            className="absolute -z-10 justify-center object-contain"
          />
          <Image
        ...
        {/* here text + buttons */}
        <div className="flex flex-row border-4 border-green">
          <div className="flex flex-col items-start border-4 border-green-500 gap-[22px] break-625:items-end break-625:gap-[31px]">
