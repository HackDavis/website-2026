  ...
  const teams = [
    {
      ...
      answer: (
        <>
          ...
          Strong experience with Next.js, TypeScript, MongoDB, REST APIs, and
          full stack development. Desire to learn and grow in web development.
          Ability to work well in a team and take constructive feedback
          positively. Passion for technology and keeping up with industry
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="w-full">
            <h1
              id="teams"
              className="text-[4rem] font-bold text-[var(--text-light)] font-[var(--font-metropolis)] max-[760px]:text-[2.5rem] "
            >
              Teams
            </h1>
            <p className="font-[var(--font-metropolis)] font-semibold pb-[4%] text-[14px] md:text-[18px]">
              (* has open roles)
            </p>
